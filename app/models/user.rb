...
class User < ActiveRecord::Base
  ...
  has_attached_file :avatar, styles: { medium: "300x300>", thumb: "100x100#",convert_options: { thumb: " -gravity center -crop '100x100+0+0'" } }, default_url: "https://s3.amazonaws.com/alejoescobar/100Preguntas/owl.png"
